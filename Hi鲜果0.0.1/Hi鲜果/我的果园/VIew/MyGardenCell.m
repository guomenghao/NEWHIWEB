...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20 + CGRectGetMaxX(self.icon.frame), self.icon.frame.origin.y, 100*[FlexibleFrame ratios].width, 32*[FlexibleFrame ratios].height)];
