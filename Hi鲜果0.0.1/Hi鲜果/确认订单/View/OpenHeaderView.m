...
- (UILabel *)titleLabel {
    ...
    if (_titleLabel == nil) {
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(16, -20*[FlexibleFrame ratios].height, self.bounds.size.width - 20 - 10, self.bounds.size.height)];
...
- (UIButton *)openButton {
    ...
    if (_openButton == nil) {
        _openButton = [[UIButton alloc] initWithFrame:CGRectMake(self.bounds.size.width - 16 - 10 * [FlexibleFrame ratios].height, -10*[FlexibleFrame ratios].height, 20*[FlexibleFrame ratios].height, 20*[FlexibleFrame ratios].height)];
